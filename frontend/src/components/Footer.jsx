    ...
    <footer className="bg-[#1a1a1a] text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 border-b border-[#FF6F00] pb-2 inline-block">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 border-b border-[#FF6F00] pb-2 inline-block">Customer Service</h3>
            <ul className="space-y-3 text-gray-400">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 border-b border-[#FF6F00] pb-2 inline-block">Contact Info</h3>
            <ul className="space-y-3 text-gray-400">
